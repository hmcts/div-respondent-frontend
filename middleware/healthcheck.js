...
const checks = () => {
  return {
    ...
    'case-orchestration-service': healthcheck.web(`${config.services.caseOrchestration.baseUrl}/health`,
    ...
    'evidence-management-client': healthcheck.web(`${config.services.evidenceManagement.baseUrl}/health`,
