const modulePath = 'steps/correspondent/cr-confirm-defence/CrConfirmDefence.step.js';
const CrConfirmDefence = require(modulePath);
const ChooseAResponse = require('steps/correspondent/cr-choose-a-response/CrChooseAResponse.step');
const CrConfirmDefenceContent = require(
  'steps/correspondent/cr-confirm-defence/CrConfirmDefence.content'
);
