const modulePath = 'steps/correspondent/cr-agree-to-pay-costs/CrAgreeToPayCosts.step';
...
const AgreeToPayCostsContent = require(
  'steps/correspondent/cr-agree-to-pay-costs/CrAgreeToPayCosts.content'
);
...
describe(modulePath, () => {
  ...
  it('renders the content', () => {
    return content(CrAgreeToPayCosts, {}, { ignoreContent: ['info', 'cya'] });
  });
});
